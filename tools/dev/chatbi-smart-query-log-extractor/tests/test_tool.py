...
class ExtractorTests(unittest.TestCase):
    ...
    def test_render_html_shows_reject_follow_up_and_sql_rewrite_copy_actions(self) -> None:
        ...
        self.assertIn(">RejectRequest<", html)
        self.assertIn(">AskHuman<", html)
    ...
    def test_render_html_shows_navigation_prompt_and_missing_markers(self) -> None:
        ...
        self.assertIn('class="flow-connector-line"', html)
        self.assertIn('flow-connector-loop', html)
        ...
        self.assertIn(">2.3 预处理判定<", html)
        self.assertIn(">3.6 最终 Prompt<", html)
        self.assertIn(">结束<", html)
        self.assertIn(">输出最终IR<", html)
