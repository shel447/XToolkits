...
class ExtractorTests(unittest.TestCase):
    ...
    def test_render_html_shows_navigation_prompt_and_missing_markers(self) -> None:
        ...
        self.assertIn("const insideFlowWrap = target instanceof Element && Boolean(target.closest('.flow-svg-wrap'));", html)
        self.assertIn("if (!(event.ctrlKey || event.metaKey || insideFlowWrap)) {", html)
