...
class ExtractorTests(unittest.TestCase):
    ...
    def test_extract_report_populates_preprocess_and_sql_stage_fields(self) -> None:
        ...
        self.assertEqual(match["compiled_sql"], "select 1")
        self.assertIn("表不存在：missing_sales，错误详情 表元数据缺失", match["recalled_tables"])
        self.assertEqual(match["step_timings"]["start"]["elapsed_ms"], 0)
        self.assertEqual(match["step_timings"]["ac_enriched_question"]["elapsed_ms"], 1)
        self.assertEqual(match["step_timings"]["preprocess_knowledge"]["elapsed_ms"], 6)
        self.assertEqual(match["step_timings"]["preprocess_decision"]["elapsed_ms"], 7)
        self.assertEqual(match["step_timings"]["mask_question"]["elapsed_ms"], 9)
        self.assertEqual(match["step_timings"]["sql_knowledge"]["elapsed_ms"], 20)
        self.assertEqual(match["step_timings"]["sql_rewrite"]["elapsed_ms"], 22)
        self.assertEqual(match["step_timings"]["recalled_tables"]["elapsed_ms"], 23)
        self.assertEqual(match["step_timings"]["final_prompt"]["elapsed_ms"], 26)
        self.assertEqual(match["step_timings"]["generated_ir"]["elapsed_ms"], 27)
        self.assertEqual(match["step_timings"]["verifier"]["elapsed_ms"], 28)
        self.assertEqual(match["step_timings"]["end"]["elapsed_ms"], 28)
    ...
    def test_render_html_shows_reject_follow_up_and_sql_rewrite_copy_actions(self) -> None:
        ...
        self.assertIn("未执行（流程在拒答/追问阶段终止）", html)
        self.assertRegex(html, r'id="flow-node-question-1-match-1-preprocess-decision"[^>]*flow-node-reject')
        self.assertRegex(html, r'id="flow-node-question-1-match-1-mask-question"[^>]*flow-node-unknown')
        self.assertRegex(html, r'id="flow-node-question-2-match-1-preprocess-decision"[^>]*flow-node-follow-up')
        ...
        self.assertIn(">编译 SQL<", html)
        self.assertIn(">执行SQL查询数据<", html)
        self.assertIn(">Data2Chart<", html)
        self.assertIn("<summary>编译 SQL</summary>", html)
        self.assertIn(">20ms<", html)
        self.assertIn("累计耗时: 20ms", html)
    ...
    def test_render_html_shows_navigation_prompt_and_missing_markers(self) -> None:
        ...
        self.assertIn('class="nav-question-item"', html)
        self.assertIn('class="nav-match-item"', html)
        self.assertIn('data-question-text="近7天销售额是多少"', html)
        self.assertIn('data-flow-status="', html)
        self.assertIn('data-retry-count="', html)
        self.assertIn('class="nav-match-time">2026-04-03 09:15:00.001</span>', html)
        self.assertIn('class="summary-grid">', html)
        self.assertIn(".nav {", html)
        self.assertIn(".nav-controls {", html)
        self.assertIn(".nav-list-shell {", html)
        self.assertIn("height: calc(100vh - 24px);", html)
        self.assertIn("overflow: hidden;", html)
        self.assertIn("grid-template-rows: auto auto minmax(0, 1fr);", html)
        self.assertIn("overflow-y: auto;", html)
        self.assertIn('id="nav-search-input"', html)
        self.assertIn('id="nav-status-toggle"', html)
        self.assertIn('id="nav-status-menu"', html)
        self.assertIn('id="nav-retry-min-input"', html)
        self.assertIn('id="nav-reset-button"', html)
        self.assertIn('id="nav-empty-state"', html)
        self.assertIn('class="nav-list-shell"', html)
        self.assertIn("label = '状态(全)';", html)
        self.assertIn("label = `状态(${selectedCount})`;", html)
        self.assertNotIn("label = `状态: ${selectedCount}项`;", html)
        self.assertIn('data-status-filter="success"', html)
        self.assertIn('data-status-filter="failed"', html)
        self.assertIn('data-status-filter="unknown"', html)
        self.assertIn('data-status-filter="reject"', html)
        self.assertIn('data-status-filter="follow_up"', html)
        self.assertNotIn('id="nav-sort-select"', html)
        ...
        self.assertIn('class="content-tabs"', html)
        self.assertIn('id="content-tab-flow"', html)
        self.assertIn('id="content-tab-details"', html)
        self.assertIn('id="content-panel-flow"', html)
        self.assertIn('id="content-panel-details"', html)
        ...
        self.assertIn('class="flow-stage-controls flow-stage-controls-overlay"', html)
        self.assertIn('id="flow-stage-canvas"', html)
        self.assertIn('--flow-svg-scale: 82%;', html)
        self.assertIn('width: var(--flow-svg-scale, 82%);', html)
        self.assertIn('class="flow-stage"', html)
        self.assertIn('class="flow-stage-body"', html)
        self.assertIn(".flow-stage-controls-overlay {", html)
        ...
        self.assertIn('data-active-match-anchor="question-1-match-1"', html)
        self.assertIn('flow-connector-line', html)
        self.assertIn('flow-connector-active', html)
        self.assertIn('class="flow-edge-label"', html)
        self.assertIn('id="flow-arrow-head-question-1-match-1"', html)
        self.assertIn('marker-end="url(#flow-arrow-head-question-1-match-1)"', html)
        ...
        self.assertIn("function loadNavFilterState()", html)
        self.assertIn("function saveNavFilterState()", html)
        self.assertIn("function applyNavigationFilters()", html)
        self.assertIn("function bindNavigationControls()", html)
        self.assertIn("function getVisibleMatchAnchors()", html)
        self.assertIn("function ensureActiveMatchIsVisible()", html)
        self.assertIn("function toggleStatusMenu(forceOpen = null)", html)
        self.assertIn("function updateStatusToggleLabel()", html)
        self.assertIn("const escapedAnchor = CSS.escape(activeAnchor);", html)
        self.assertIn("function updateActiveNavLinks(anchorId = '')", html)
        self.assertIn("function setActiveFlowView(anchorId = '', resetScroll = true)", html)
        self.assertIn("function setActiveContentTab(tabKey = 'flow')", html)
        self.assertIn("function bindFlowStageNavigation()", html)
        self.assertIn("function bindFlowWheelZoom()", html)
        self.assertIn("function setFlowZoomWithCursor(nextZoom, clientX, clientY)", html)
        self.assertIn("function positionFlowZoomControls()", html)
        self.assertIn("function activateMatchAnchor(anchorId = '', options = { preserveTab: true, scrollDetails: false, resetFlowScroll: true })", html)
        self.assertIn("const currentMatchAnchor = getActiveMatchAnchorFromViewport();", html)
        self.assertIn("scrollDetailsToAnchor(currentMatchAnchor);", html)
        self.assertIn("classList.add('nav-active')", html)
        self.assertIn("classList.add('nav-question-active')", html)
        self.assertIn("classList.add('nav-parent-active')", html)
        self.assertIn("statusFilters.add(status);", html)
        self.assertIn("questionItems.forEach((questionItem) => {", html)
        self.assertIn("const searchKeyword = navFilterState.searchText.trim().toLowerCase();", html)
        self.assertIn("const minRetryCount = Number.parseInt(navFilterState.minRetryCount || '0', 10);", html)
        self.assertIn("const retryCount = Number.parseInt(matchItem.getAttribute('data-retry-count') || '0', 10);", html)
        self.assertIn("const visible = questionMatchesSearch && statusFilters.has(flowStatus) && retryCount >= minRetryCount;", html)
        self.assertIn("navFilterState.minRetryCount = retryMinInput.value;", html)
        self.assertIn("toggleStatusMenu(false);", html)
        self.assertNotIn("const sortOrder = navFilterState.sortOrder;", html)
        self.assertIn("flowPanelBody.addEventListener('wheel', (event) => {", html)
        self.assertIn("if (activeContentTab !== 'flow') {", html)
        self.assertIn("if (!(event.ctrlKey || event.metaKey)) {", html)
        self.assertIn("setFlowZoomWithCursor(nextZoom, event.clientX, event.clientY);", html)
        self.assertIn("const zoomRatio = clampedZoom / previousZoom;", html)
        self.assertIn("flowPanelBody.scrollLeft = Math.max(0, worldX * zoomRatio - pointerX);", html)
        self.assertIn("if (event.ctrlKey || event.metaKey) {", html)
        self.assertIn("const FLOW_SWITCH_EDGE_GAP = 8;", html)
        self.assertIn("const FLOW_SWITCH_CONFIRM_DELAY_MS = 500;", html)
        self.assertIn("const FLOW_SWITCH_COOLDOWN_MS = 360;", html)
        self.assertIn("function resetFlowBoundarySwitchIntent()", html)
        self.assertIn("if (now - lastFlowSwitchAt < FLOW_SWITCH_COOLDOWN_MS) {", html)
        self.assertIn("if (flowBoundaryPendingDirection !== direction) {", html)
        self.assertIn("flowBoundaryPendingAt = now;", html)
        self.assertIn("if (now - flowBoundaryPendingAt < FLOW_SWITCH_CONFIRM_DELAY_MS) {", html)
        self.assertIn("flowPanelBody.addEventListener('scroll', () => {", html)
        self.assertIn("bindFlowWheelZoom();", html)
        self.assertIn("positionFlowZoomControls();", html)
        ...
        self.assertIn("-ms-overflow-style: none;", html)
        self.assertIn(".content-panel-body::-webkit-scrollbar {", html)
        self.assertIn("width: 0;", html)
        self.assertIn('id="settings-toggle"', html)
        self.assertIn('id="settings-panel"', html)
        self.assertIn('id="settings-list"', html)
        self.assertIn("DETAIL_FIELD_OPTIONS", html)
        self.assertIn("{ key: 'flow_diagram', label: '流程图' }", html)
        self.assertIn("applyDetailVisibility()", html)
        self.assertIn("applyNavigationFilters();", html)
        self.assertIn(">开始<", html)
        self.assertNotIn(">1 提取用户问题<", html)
        self.assertIn(">实体检索<", html)
        self.assertIn(">拒答/追问判定<", html)
        self.assertIn(">检索SQL生成知识<", html)
        self.assertIn(">问题改写<", html)
        self.assertIn(">拼装Prompt<", html)
        self.assertIn(">生成 IR<", html)
        self.assertIn(">校验<", html)
        self.assertIn(">结束<", html)
        self.assertNotIn(">2.1 实体检索<", html)
        self.assertNotIn(">3.2 检索SQL生成知识<", html)
        self.assertIn(">问数<", html)
        self.assertIn(">拒答<", html)
        self.assertIn(">追问<", html)
        self.assertIn('class="flow-tooltip-popup"', html)
        self.assertNotIn('class="flow-sidebar"', html)
    ...
    def test_render_html_shows_retry_badges_and_failure_blocks(self) -> None:
        ...
        self.assertIn("编译失败重试次数：3", html)
        self.assertIn("编译失败原因统计", html)
        self.assertIn("<strong>1次</strong> first verifier failure", html)
        self.assertIn("<strong>1次</strong> second verifier failure", html)
        self.assertIn("<strong>1次</strong> second call verifier failure", html)
        ...
        self.assertIn("编译失败重试次数：2", html)
        self.assertIn("编译失败重试次数：1", html)
        self.assertIn("编译失败记录", html)
        ...
        self.assertRegex(html, r'id="flow-node-question-1-match-1-end"[^>]*flow-node-success')
        self.assertRegex(html, r'id="flow-node-question-1-match-2-verifier"[^>]*flow-node-failed')
        self.assertRegex(html, r'id="flow-node-question-2-match-1-end"[^>]*flow-node-unknown')
        self.assertIn(">编译失败重试 2 次<", html)
        self.assertIn(">最终失败<", html)
        self.assertIn("未命中结束信号，流程可能中断或服务重启。", html)
        self.assertIn("已到达，未提取到详情", html)
        self.assertIn('data-active-match-anchor="question-1-match-1"', html)
    ...
    def test_render_html_merges_same_retry_reason_counts_in_summary(self) -> None:
        ...
        self.assertIn("编译失败重试次数：2", html)
        self.assertIn("编译失败原因统计", html)
        self.assertIn("<strong>2次</strong> same reason", html)
