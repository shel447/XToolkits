...
class ExtractorTests(unittest.TestCase):
    ...
    def test_render_html_shows_reject_follow_up_and_sql_rewrite_copy_actions(self) -> None:
        ...
        self.assertIn('id="flow-sidebar"', html)
    ...
    def test_render_html_shows_navigation_prompt_and_missing_markers(self) -> None:
        ...
        self.assertIn("grid-template-columns: 280px minmax(0, 1fr) 396px;", html)
        self.assertIn("top: 12px;", html)
        self.assertIn('id="flow-sidebar"', html)
        self.assertIn('class="flow-sidebar"', html)
        self.assertIn('class="flow-sidebar-body"', html)
        ...
        self.assertNotIn('class="flow-diagram"', html)
