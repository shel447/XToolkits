...
class ExtractorTests(unittest.TestCase):
    ...
    def test_render_html_shows_navigation_prompt_and_missing_markers(self) -> None:
        ...
        self.assertIn("grid-template-columns: 260px minmax(420px, 1.2fr) minmax(360px, 0.95fr);", html)
        ...
        self.assertIn('class="detail-column"', html)
        ...
        self.assertIn("window.addEventListener('scroll', syncActivePanels, { passive: true });", html)
