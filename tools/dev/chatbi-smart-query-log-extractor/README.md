...
```text
python -m chatbi_smart_query_log_extractor --log <log-file> [--question "<exact question>"] [--output-dir <dir>] [--encoding <name>] [--json-only] [--html-only] [--serve] [--host <host>] [--port <port>]
```
